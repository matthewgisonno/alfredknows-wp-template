 ...
 * @return {Object} - this
 */
function _alfredKnowsColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_alfredKnowsColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_alfredKnowsColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_alfredKnowsColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _alfredKnowsColor object.
 *
 * @since Alfred Knows 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function alfredKnowsColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _alfredKnowsColor( backgroundColor, accentHue );
